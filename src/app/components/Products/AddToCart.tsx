...
const AddToCart = ({ handleRemoveFromCart, handleAddToCart, count }: AddToCartProps) => {
  return count === 0 ? (
    <button onClick={handleAddToCart} className=" primary-btn px-4 py-2  w-32 ">
      Add to cart
    </button>
  ) : (
    <>
      <div className="cart-controls px-4 py-2 w-32 flex items-center justify-between primary-btn">
